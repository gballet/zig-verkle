...
pub const Node = union(enum) {
    ...
    pub fn new(allocator: Allocator, crs: *CRS) !@This() {
    ...
    pub fn insert(self: *Node, key: Key, value: *const Slot, allocator: Allocator, crs: *CRS) !void {
    ...
    pub fn tear_down(self: *Node, allocator: Allocator) void {
        switch (self.*) {
            .empty => {},
            .last_level => |ll| {
                for (ll.values) |v| {
    ...
    pub fn toDot(self: *const Node, str: *std.ArrayList(u8), path: []const u8, parent: []const u8) !void {
